...
class OdomFramePublisher(object):
    ...
    def __init__(self):
        ...
        wait_service_name = rospy.get_param('~wait_service','/t265_to_base_link_virtual_joint/get_loggers')
        #
        rospy.wait_for_service(wait_service_name, timeout=30.0)
        ...
        if self.flag:
            ...
            while True:
                try:
                    ...
                    rospy.logwarn('lookup transform has failed.')
